...
class DPO_Group
{
    ...
    public function logPostRequest($logging_path, $prefix, $type): void
    {
    ...
    public function savePostSession(): void
    {
        $_SESSION          = $_POST;
    ...
    public function logData($msg = '', $close = false): void
    {
        static $fh = 0;
        ...
        if ($close) {
            ...
            if ( ! $fh) {
                ...
                $fh       = fopen($pathinfo['dirname'] . '/dpo_group.log', 'a+');
            }
