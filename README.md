# DPO_Gravity_Forms
## DPO Group WooCommerce plugin v1.0.0 for Gravity Forms v2.4.15, WordPress v5.3.0

This is the DPO Group plugin for Gravity Forms. Please feel free to contact the [DPO Group support team](https://www.directpay.online/support/) should you require any assistance.

## Installation
Please navigate to the [releases page](https://github.com/DirectPay-Online/DPO_Gravity_Forms/releases), download the latest release (v1.0.0) and unzip. You will them be able to follow the integration guide which is included in the zip.
