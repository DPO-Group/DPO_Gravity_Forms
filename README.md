...
## Installation
Please navigate to the [releases page](https://github.com/DirectPay-Online/DPO_Gravity_Forms/releases), download the latest release (v1.0.2) and unzip. You will then be able to follow the integration guide which is included in the zip.
